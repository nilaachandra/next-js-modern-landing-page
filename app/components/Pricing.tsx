...
export function Pricing() {
  return (
    <div className="py-[48px] lg:py-[60px]">
      <h1 className="text-[#172026] text-center font-bold  text-2xl lg:text-[42px]">
      ...
      <div className="flex flex-col gap-y-6 gap-x-[24px] lg:flex-row">
        <div className="w-full rounded-[8px] bg-[#e6e6ee] cursor-pointer hover:bg-zinc-400 transition-colors duration-200 p-6 shadow-lg flex flex-col lg:justify-between">
          <div>
            <h3 className="font-medium text-[#4328EB] text-[18px] lg:text-xl">
              Free Trial
            </h3>
            <p className="pt-[12px] text-black lg:text-[18px]">
              Perfect for testing the waters
            </p>

            <h2 className="pt-4 text-2xl font-medium lg:text-[32px]">
              0$<span className="text-black">/mo</span>
            </h2>

            <ul className="flex flex-col gap-y-2 pt-4 text-black">
        ...
        <div className="w-full rounded-[8px] bg-[#e6e6ee] cursor-pointer hover:bg-zinc-400 transition-colors duration-200 p-6 flex flex-col lg:justify-between">
          <div>
            <h3 className="font-medium text-[#4328EB] text-[18px] lg:text-xl">
              Enterprise
            </h3>
